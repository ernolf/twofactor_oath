...
- Import the @nextcloud/vue components directly (#100)
- Restore the Doctrine docblock suppressions for the pinned OCP (#102)

[0.4.3]: https://github.com/ernolf/twofactor_oath/releases/tag/v0.4.3
...
- Delete the OATH secret when a user is deleted (#96)

[0.4.2]: https://github.com/ernolf/twofactor_oath/releases/tag/v0.4.2
...
[0.4.1]: https://github.com/ernolf/twofactor_oath/releases/tag/v0.4.1
...
[0.4.0]: https://github.com/ernolf/twofactor_oath/releases/tag/v0.4.0
...
[0.3.2]: https://github.com/ernolf/twofactor_oath/releases/tag/v0.3.2
...
[0.3.1]: https://github.com/ernolf/twofactor_oath/releases/tag/v0.3.1
...
[0.3.0]: https://github.com/ernolf/twofactor_oath/releases/tag/v0.3.0
